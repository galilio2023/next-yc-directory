        ...
        <div className="flex w-full flex-col justify-center p-10 lg:w-1/2 lg:p-16">
          ...
          <div className="mt-12 flex items-center justify-between border-t border-white/5 pt-10">
            <div className="flex items-center gap-4">
              <div className="relative h-12 w-12 overflow-hidden rounded-2xl border-2 border-primary/20 bg-slate-800 shadow-xl transition-transform group-hover:scale-110">
                {author?.image ? (
